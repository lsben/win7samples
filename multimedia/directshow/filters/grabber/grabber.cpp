...
// ========= msw ===============
//
// - Modified 2017-09-27, mainly simplified, following
//   https://msdn.microsoft.com/en-us/library/ms867162.aspx "How To Get Data
//   from a Microsoft DirectShow Filter Graph"
//   -----------------------------------------------------------------------------
...
HRESULT CSampleGrabberAllocator::SetProperties(
    ...
    if (pRequest->cbPrefix != pRequired->cbPrefix ||
        pRequest->cbBuffer > pRequired->cbBuffer  ||
        pRequest->cBuffers > pRequired->cBuffers) { return E_FAIL;  }
